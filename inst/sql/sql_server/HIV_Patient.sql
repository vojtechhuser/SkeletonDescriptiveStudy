...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4008081,45576260,44824945,44829737,439727,44828699,44829310)
...
FROM
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4008081)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
